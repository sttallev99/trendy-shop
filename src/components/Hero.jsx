...
const Hero = () => {
  return (
    <section id='home' className='max-padd-container bg-hero bg-center bg-cover bg-no-repeat h-[777px] w-full max-[640px]:bg-left backdrop-blur-md'>
      <div className='relative max-w-[666px] top-44 xs:top-72'>
        <p className='pt-2 pb-10'>If you load the app for the first time it may take a few seconds longer. Thanks for you understanding.</p>
