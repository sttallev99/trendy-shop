...
export const ProductMd = (props) => {
  ...
  return (
    <section className='max-padd-container flex flex-col gap-8 xl:flex-row bg-primary py-4'>
        ...
        {/*right side*/}
        <div className=' max-padd-container flex-col flex xl:flex-[1.5] bg-white py-2 rounded-xl '>
            ...
            <div className='flex flex-col sm:flex-row gap-x-10 gap-y-3 my-4'>
                <div>
                    ...
                    <div className="flex gap-3 my-4">
                        <div className='h-10 w-10 flexCenter cursor-pointer rounded-sm bg-secondaryRed'></div>
